...
<div class="row">
    ...
    <form id="msform">
            ...
            <fieldset>
              ...
              <div class="col-sm-4 col-xs-12">
                   <input type="text" id="land_line" placeholder="Land Line">
              </div>

              <div class="col-sm-4 col-xs-12">
                    <input type="text" id="office_phone" placeholder="Office Phone">
              </div>
               ...
               <div class="col-sm-4 col-xs-12">
                    <input class="datepicker" placeholder="Date Of Birth" id="date_of_birth">
               </div>
                          <!-- javascript --><script>
              ...
              <div class="col-sm-4 col-xs-12">
                  <input type="text" id="doorno" placeholder="Door Number">
              </div>

              <div class="col-sm-4 col-xs-12">
                  <input type="text" id="building_street" placeholder="Building/Street Name">
              </div>

              <div class="col-sm-4 col-xs-12">
                <input type="text" id="area_locality" placeholder="Area/Locality Name" >
              </div>
              ...
              <div class="col-sm-4 col-xs-12">
                <input type="text" id="pincode" placeholder="Area Pin Code">
              </div>
